...
parser = argparse.ArgumentParser(
    description="Simulate a coin flip a certain amount of times and display the results.")
...
def askHowManyTimesToRepeat():
    timesToRepeat = int(
        input("Enter the amount of times you would like the coin to be flipped: "))
...
def askToShowVisualOutput():
    visualOutputYesOrNo = input(
        "Would you like to visually output the result of each toss? Y/N: ").lower()
...
def outputAnalysis():
	global tailspercent, headspercent, difference, longTailValue, longHeadValue, elapsedtime
...
def outputLogFile():
	if logFileName.lower() != "n":
		...
		logfile.write("Tails was flipped " + str(tails) +
		              " times, or " + str(tailspercent) + "% of the time.\n")
		logfile.write("Heads was flipped " + str(heads) +
		              " times, or " + str(headspercent) + "% of the time.\n")
		logfile.write("The difference between the two was " +
		              str(difference) + ".\n")
		logfile.write("The longest string of tails in a row was " +
		              str(longTailValue) + ".\n")
		logfile.write("The longest string of heads in a row was " +
		              str(longHeadValue) + ".\n")
		logfile.close()
